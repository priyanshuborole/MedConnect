package com.priyanshudev.common.data.datasource
...
private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(
    name = "MEDCONNECT_PREFERENCE"
)
class MedConnectDataStoreImpl constructor(context: Context) : MedConnectDataStore {
